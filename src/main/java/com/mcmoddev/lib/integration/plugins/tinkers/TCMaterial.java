...
public class TCMaterial {
	...
	// All constructors are private - use the 'get' (or whatever they wind up being
	// named) static's
	private TCMaterial() {
	...
	public HeadMaterialStats getHeadStats() {
		if (this.headStats == null)
			this.headStats = new HeadMaterialStats(this.headDurability, this.miningSpeed, this.headAttackDamage,
					this.miningLevel);
	...
	public Item getRepresentativeItem() {
		// if it hasn't been done yet, just return null - or the item doesn't exist -
		// just return null
