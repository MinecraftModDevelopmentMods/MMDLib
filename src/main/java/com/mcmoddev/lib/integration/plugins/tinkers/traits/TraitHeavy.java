...
public class TraitHeavy extends AbstractTrait {
	...
	public float knockBack(@Nonnull final ItemStack tool, @Nonnull final EntityLivingBase player,
			@Nonnull final EntityLivingBase target, @Nonnull final float damage, @Nonnull final float knockback,
			@Nonnull final float newKnockback, @Nonnull final boolean isCritical) {
